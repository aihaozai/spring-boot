...
public class ShiroConfig {
    ...
    private CookieRememberMeManager rememberMeManager() {
        ...
        String encryptKey = "system_shiro_key";
    ...
    public DefaultWebSessionManager sessionManager() {
        ...
        // 设置 session超时时间
        sessionManager.setGlobalSessionTimeout(systemProperties.getShiro().getSessionTimeout() * 1000L);
